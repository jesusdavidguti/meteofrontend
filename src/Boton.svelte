<script>
  ...
  export let coleccion = "avisos"; // fenómenos, previsiones
  ...
  onMount(() => {
    ...
    switch (coleccion) {
      ...
      case "avisos":      url=URL.avisos; break;
      case "fenomenos":   url=URL.fenomenos; break;      
      case "previsiones": url=URL.previsiones; break;
